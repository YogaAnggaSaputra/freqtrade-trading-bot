#!/usr/bin/env python3
"""Sync feather files to PostgreSQL - fixed path"""
import pandas as pd
...
async def sync():
    ...
    # Data directory - check both possible locations
    base_dirs = [
        '/freqtrade/user_data/data/futures',
        '/data/futures',
        '/app/futures',
        '/home/ngodingyuk/freqtrade/user_data/data/futures'
    ]
